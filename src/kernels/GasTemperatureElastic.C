#include "GasTemperatureElastic.h"

// MOOSE includes
#include "MooseUtils.h"
#include "MooseVariable.h"

registerADMooseObject("CraneApp", GasTemperatureElastic);

InputParameters
GasTemperatureElastic::validParams()
{
  InputParameters params = ADKernel::validParams();
  params.addRequiredCoupledVar("potential", "The potential.");
  params.addRequiredCoupledVar("electrons", "The electron density.");
  params.addRequiredCoupledVar("mean_energy", "The electron energy density.");
...
GasTemperatureElastic::GasTemperatureElastic(const InputParameters & parameters)
  : ADKernel(parameters),
