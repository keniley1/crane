#include "ConstantReactionLog.h"

// MOOSE includes
#include "MooseUtils.h"
#include "MooseVariable.h"

registerADMooseObject("CraneApp", ConstantReactionLog);

InputParameters
ConstantReactionLog::validParams()
{
  InputParameters params = ReactionLogBase::validParams();

  params.addParam<std::string>("reaction", "", "The reaction string.");
  params.addParam<std::string>(
      "rate_coefficient_name",
      "The name of the material property containing this coefficient. By default the "
...
ConstantReactionLog::ConstantReactionLog(const InputParameters & parameters)
  : ReactionLogBase(parameters),
    _r_units(1. / getParam<Real>("position_units")),
    _rate_coefficient(getADMaterialProperty<Real>(
...
ADReal
ConstantReactionLog::computeQpResidual()
{
  return -_test[_i][_qp] * ReactionLogBase::multiplyReactants() * _rate_coefficient[_qp] *
         _stoichiometric_value;
}
